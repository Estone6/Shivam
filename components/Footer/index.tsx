            ...
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <p className="mb-10 mt-5">
                  Empowering IT and Non-IT Professionals.
                </p>
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            >
              <ul className="flex items-center gap-5">
                <li>
                  <a target="_blank" href="https://www.facebook.com/profile.php?id=61565176437553" aria-label="social icon">
                    <svg
                ...
                <li>
                  <a target="_blank" href="https://x.com/TechUnic0rn" aria-label="social icon">
                    <svg
                      className="fill-[#D1D8E0] transition-all duration-300 hover:fill-primary"
                      width="24"
                      height="24"
