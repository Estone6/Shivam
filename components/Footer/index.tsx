      ...
      <footer className="border-t border-stroke bg-white dark:border-strokedark dark:bg-blacksection">
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-22">
            <div className="flex flex-wrap gap-8 lg:justify-between lg:gap-0">
              ...
              >
                ...
                <span className="text-3xl text-black font-bold">Tech Unicorn</span>

                <p className="mb-10 mt-5">
                  Empowering IT Careers with Expert Training.
                </p>
                ...
                <div className="flex justify-around flex-wrap gap-5">
                  <a
                    ...
                    className="text-xl underline font-medium text-black dark:text-white"
                  >
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark">
            ...
            >
              <p>
                &copy; {new Date().getFullYear()} Tech Unicorn. All rights reserved
              </p>
            </motion.div>
          </div>
          {/* <!-- Footer Bottom --> */}
