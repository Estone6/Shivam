      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Effortlessly Stay Connected, Anytime, Anywhere`,
              description: `At Tech Unicorn Academy, we integrate with the tools you already use, making it easier to stay connected, collaborate, and manage your learning experience. Whether you’re tracking your progress, joining live sessions, or engaging with fellow students, our platform supports seamless integration with the best apps.`,
            }}
          />
