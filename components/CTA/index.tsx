          ...
          <div className="flex flex-wrap gap-8 md:flex-nowrap md:items-center md:justify-between md:gap-0">
            ...
            >
              <h2 className="mb-4 w-11/12 text-3xl font-bold text-black dark:text-white xl:text-sectiontitle4">
                Join Us Today & Kickstart Your Tech Career
              </h2>
              <p>
                Don't wait to take the next step towards a brighter future in tech. Enroll now in our expert-led courses, and gain the skills you need to excel in the competitive tech industry.
              </p>
            </motion.div>
            <motion.div
              variants={{
